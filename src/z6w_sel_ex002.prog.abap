*&---------------------------------------------------------------------*
*& Report Z6W_SEL_EX002
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT Z6W_SEL_EX002.

SELECTION-SCREEN BEGIN OF BLOCK section01 WITH FRAME TITLE text-001.
PARAMETERS field(10) TYPE c OBLIGATORY.
SELECTION-SCREEN END OF BLOCK section01.
...
PARAMETERS P01 TYPE spfli-carrid.
