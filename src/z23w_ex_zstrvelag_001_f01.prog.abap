...
FORM upload_from_excel .
  ...
  SELECT COUNT( DISTINCT FIELDNAME ) FROM DD03L WHERE TABNAME = 'ZSTRAVELAG' INTO @lv_numberofcolumns.
...
FORM download_excel_smpl USING p_fname.
  ...
  DATA: lo_excel      TYPE REF TO zcl_excel,
        ...
        lv_action     TYPE i,
        lv_tabname    TYPE tabname VALUE 'STRAVELAG',
...
LOOP AT GT_FCAT INTO GS_FCAT WHERE FIELDNAME = 'AGENCYNUM'.
  GS_FCAT-LZERO   = 'X'.
