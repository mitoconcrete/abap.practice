...
DATA: gt_collect TYPE STANDARD TABLE OF it_sflight,
      gt_collect2 TYPE STANDARD TABLE OF it_sflight.
...
FORM data_retrieval.
    ...
    LOOP AT gt_sflight INTO wa_sflight.
       AT END OF carrid.
          SUM.
          APPEND wa_sflight TO gt_collect.
       ENDAT.

       AT END OF connid.
          SUM.
          APPEND wa_sflight TO gt_collect2.
       ENDAT.
    ENDLOOP.
