...
DATA: GT_TABLE TYPE TABLE OF ZSPFLI,
      GS_TABLE TYPE          ZSPFLI.
...
DATA: it_cp TYPE TABLE OF ZSPFLI WITH HEADER LINE,
      it_changes  TYPE TABLE OF ZSPFLI WITH HEADER LINE,
      it_deletes  TYPE TABLE OF ZSPFLI WITH HEADER LINE.
